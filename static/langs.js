const translations = {
    ...
    'en': {
        ...
        'upload-success': 'Upload successful! Original filename preserved',
    ...
    'de': {
        ...
        'upload-success': 'Upload erfolgreich! Ursprünglicher Dateiname beibehalten',
    ...
    'ru': {
        ...
        'upload-success': 'Загрузка успешна! Исходное имя файла сохранено',
    ...
    'fr': {
        ...
        'upload-success': 'Téléchargement réussi! Nom de fichier d\'origine conservé',
    ...
    'es': {
        ...
        'upload-success': '¡Carga exitosa! Nombre de archivo original conservado',
    ...
    'ar': {
        ...
        'upload-success': 'تم التحميل بنجاح! تم الاحتفاظ باسم الملف الأصلي',
    ...
    'fa': {
        ...
        'upload-success': 'آپلود موفق! نام فایل اصلی حفظ شد',
    ...
    'tr': {
        ...
        'upload-success': 'Yükleme başarılı! Orijinal dosya adı korundu',
    ...
    'pt': {
        ...
        'upload-success': 'Upload bem-sucedido! Nome do arquivo original preservado',
    ...
    'ko': {
        ...
        'upload-success': '업로드 성공! 원본 파일 이름이 보존되었습니다',
    ...
    'ja': {
        ...
        'upload-success': 'アップロード成功！元のファイル名が保存されました',
